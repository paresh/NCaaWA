 ...
 *
 */
public class Tandem_1SC_3Flows_1AC_3Paths
{
	...
	public Tandem_1SC_3Flows_1AC_3Paths( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
...
//--------------------Flow 0--------------------	
	...
	public void f0_tfa_fifoMux()
	{
		...
		s2.setUseFifoMultiplexing( true ); // default = false
		...
		assertEquals( "TFA FIFO delay", new Num( 55 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 450 ), tfa_results.backlog_bound );
	}
	...
	public void f0_tfa_arbMux()
	{
		...
		s2.setUseArbitraryMultiplexing( true ); // default = true
		...
		assertEquals( "TFA ARB delay", new Num( 110 ), tfa_results.delay_bound );
		assertEquals( "TFA ARB backlog", new Num( 450 ), tfa_results.backlog_bound );
	}
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO backlog", new Num( 262.5 ), sfa_results.backlog_bound );
	}
	...
	public void f0_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 170, 3 ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 300 ), pmoo_results.backlog_bound );
	}
...
//--------------------Flow 1--------------------	
	...
	public void f1_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 2205, 64 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 7825, 16 ), tfa_results.backlog_bound );
	}
	...
	public void f1_tfa_arbMux()
	{
		...
		if( config.arrivalBoundMethods().contains( ArrivalBoundMethods.PMOO ) ) {
			assertEquals( "TFA ARB delay", new Num( 72.5 ), tfa_results.delay_bound );
			assertEquals( "TFA ARB backlog", new Num( 525 ), tfa_results.backlog_bound );
		} else {
			assertEquals( "TFA ARB delay", new Num( 1405, 18 ), tfa_results.delay_bound );
			assertEquals( "TFA ARB backlog", new Num( 5225, 9 ), tfa_results.backlog_bound );
		}
	}
	...
	public void f1_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 6695, 192 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 12225, 64 ), sfa_results.backlog_bound );
	}
	...
	public void f1_sfa_arbMux()
	{
		...
		if( config.arrivalBoundMethods().contains( ArrivalBoundMethods.PMOO ) ) {
			assertEquals( "SFA ARB delay", new Num( 145, 3 ), sfa_results.delay_bound );
			assertEquals( "SFA ARB backlog", new Num( 775, 3 ), sfa_results.backlog_bound );
		} else {
			assertEquals( "SFA ARB delay", new Num( 1405, 27 ), sfa_results.delay_bound );
			assertEquals( "SFA ARB backlog", new Num( 7475, 27 ), sfa_results.backlog_bound );
		}
	}
	...
	public void f1_pmoo_arbMux()
	{
		...
		if( config.arrivalBoundMethods().contains( ArrivalBoundMethods.PMOO ) ) {
			assertEquals( "PMOO ARB delay", new Num( 145, 3 ), pmoo_results.delay_bound );
			assertEquals( "PMOO ARB backlog", new Num( 775, 3 ), pmoo_results.backlog_bound );
		} else {
			assertEquals( "PMOO ARB delay", new Num( 1405, 27 ), pmoo_results.delay_bound );
			assertEquals( "PMOO ARB backlog", new Num( 7475, 27 ), pmoo_results.backlog_bound );
		}
	}
...
//--------------------Flow 2--------------------	
	...
	public void f2_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 5725, 64 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 7825, 16 ), tfa_results.backlog_bound );
	}
	...
	public void f2_tfa_arbMux()
	{
		...
		if( config.arrivalBoundMethods().contains( ArrivalBoundMethods.PMOO ) ) {
			assertEquals( "TFA ARB delay", new Num( 182.5 ), tfa_results.delay_bound );
			assertEquals( "TFA ARB backlog", new Num( 525 ), tfa_results.backlog_bound );
		} else {
			assertEquals( "TFA ARB delay", new Num( 16925, 90 ), tfa_results.delay_bound );
			assertEquals( "TFA ARB backlog", new Num( 5225, 9 ), tfa_results.backlog_bound );
		}
	}
	...
	public void f2_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 845, 12 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 1475, 4 ), sfa_results.backlog_bound );
	}
	...
	public void f2_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 280, 3 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 1450, 3 ), sfa_results.backlog_bound );
	}
	...
	public void f2_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 85 ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 1325, 3 ), pmoo_results.backlog_bound );
	}
}