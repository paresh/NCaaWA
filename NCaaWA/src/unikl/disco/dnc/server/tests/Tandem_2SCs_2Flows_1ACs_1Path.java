 ...
 *
 */
public class Tandem_2SCs_2Flows_1ACs_1Path
{
	Configuration config;
	
	static final ServiceCurve service_curve_0 = ServiceCurve.createRateLatency( 10, 10 );
	static final ServiceCurve service_curve_1 = ServiceCurve.createRateLatency( 6, 6 );
	static final ArrivalCurve arrival_curve = ArrivalCurve.createTokenBucket( 2.5, 12.5 );
	...
	public Tandem_2SCs_2Flows_1ACs_1Path( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
	...
	{
		network = new Network();
		s0 = network.addServer( service_curve_0, max_service_curve );
		s0.setUseGamma( false );
		s0.setUseExtraGamma( false );
		
		s1 = network.addServer( service_curve_1, max_service_curve );
...
//--------------------Flow 0--------------------	
	...
	public void f0_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 31 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 105 ), tfa_results.backlog_bound );
	}
	...
	public void f0_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 136 ), tfa_results.delay_bound );
		assertEquals( "TFA ARB backlog", new Num( 105 ), tfa_results.backlog_bound );
	}
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 379, 14 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 71.25 ), sfa_results.backlog_bound );
	}
	...
	public void f0_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 277, 7 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 102.5 ), sfa_results.backlog_bound );
	}
	...
	public void f0_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 242, 7 ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 90 ), pmoo_results.backlog_bound );
	}
