 ...
 *
 */
public class Tandem_1SC_2Flows_1AC_1Path_v2
{
	...
	public Tandem_1SC_2Flows_1AC_1Path_v2( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
...
//--------------------Flow 0--------------------	
	...
	public void f0_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 97.5 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 650 ), tfa_results.backlog_bound );
	}
	...
	public void f0_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 195 ), tfa_results.delay_bound );
		assertEquals( "TFA ARB backlog", new Num( 650 ), tfa_results.backlog_bound );
	}
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 965, 12 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 1675, 4 ), sfa_results.backlog_bound );
	}
	...
	public void f0_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 320, 3 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 550 ), sfa_results.backlog_bound );
	}
	...
	public void f0_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 250, 3 ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 1300, 3 ), pmoo_results.backlog_bound );
	}
