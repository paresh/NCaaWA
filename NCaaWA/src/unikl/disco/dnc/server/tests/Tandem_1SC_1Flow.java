...
public class Tandem_1SC_1Flow
{
	...
	public Tandem_1SC_1Flow( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
	...
	public void f0_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 30 ), tfa_results.delay_bound );
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 22.5 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 125 ), sfa_results.backlog_bound );
	}
	...
	public void f0_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB backlog", new Num( 125 ), sfa_results.backlog_bound );
	}
