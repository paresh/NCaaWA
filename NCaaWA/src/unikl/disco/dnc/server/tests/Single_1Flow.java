...
public class Single_1Flow
{
	...
	public Single_1Flow( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
	...
	public void f0_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 12.5 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 75 ), tfa_results.backlog_bound );
	}
	...
	public void f0_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 12.5 ), tfa_results.delay_bound );
		assertEquals( "TFA ARB backlog", new Num( 75 ), tfa_results.backlog_bound );
	}
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 12.5 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 75 ), sfa_results.backlog_bound );
	}
	...
	public void f0_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 12.5 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 75 ), sfa_results.backlog_bound );
	}
	...
	public void f0_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 12.5 ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 75 ), pmoo_results.backlog_bound );
	}
}
