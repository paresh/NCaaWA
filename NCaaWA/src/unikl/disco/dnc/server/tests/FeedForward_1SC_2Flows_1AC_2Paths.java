 ...
 *
 */
public class FeedForward_1SC_2Flows_1AC_2Paths
{
	...
	public FeedForward_1SC_2Flows_1AC_2Paths( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
...
//--------------------Flow 0--------------------	
	...
	public void f0_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 485, 8 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 1125, 2 ), tfa_results.backlog_bound );
	}
	...
	public void f0_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 385, 3 ), tfa_results.delay_bound );
		assertEquals( "TFA ARB backlog", new Num( 1900, 3 ), tfa_results.backlog_bound );
	}
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 325, 6 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 575, 2 ), sfa_results.backlog_bound );
	}
	...
	public void f0_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 215, 3 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 375 ), sfa_results.backlog_bound );
	}
	...
	public void f0_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 215, 3 ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 375 ), pmoo_results.backlog_bound );
	}
...
//--------------------Flow 1--------------------	
	...
	public void f1_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 1395, 16 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 1125, 2 ), tfa_results.backlog_bound );
	}
	...
	public void f1_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 470, 3 ), tfa_results.delay_bound );
		assertEquals( "TFA ARB backlog", new Num( 1900, 3 ), tfa_results.backlog_bound );
	}
	...
	public void f1_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 415, 6 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 725, 2 ), sfa_results.backlog_bound );
	}
	...
	public void f1_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 85 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 1325, 3 ), sfa_results.backlog_bound );
	}
