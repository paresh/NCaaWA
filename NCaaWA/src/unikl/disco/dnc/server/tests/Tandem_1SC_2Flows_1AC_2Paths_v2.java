 ...
 *
 */
public class Tandem_1SC_2Flows_1AC_2Paths_v2
{
	...
	public Tandem_1SC_2Flows_1AC_2Paths_v2( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
...
//--------------------Flow 0--------------------	
	...
	public void f0_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 7985, 64 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 550 ), tfa_results.backlog_bound );
	}
	...
	public void f0_tfa_arbMux()
	{
		...
		if( config.arrivalBoundMethods().contains( ArrivalBoundMethods.PMOO ) ) {
			assertEquals( "TFA ARB delay", new Num( 765, 4 ), tfa_results.delay_bound );
			assertEquals( "TFA ARB backlog", new Num( 550 ), tfa_results.backlog_bound );
		} else {
			assertEquals( "TFA ARB delay", new Num( 2335, 12 ), tfa_results.delay_bound );
			assertEquals( "TFA ARB backlog", new Num( 1700, 3 ), tfa_results.backlog_bound );
		}
	}
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 535, 6 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 925, 2 ), sfa_results.backlog_bound );
	}
	...
	public void f0_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 105 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 1625, 3 ), sfa_results.backlog_bound );
	}
	...
	public void f0_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 290, 3 ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 500 ), pmoo_results.backlog_bound );
	}
...
//--------------------Flow 1--------------------	
	...
	public void f1_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 65 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 550 ), tfa_results.backlog_bound );
	}
	...
	public void f1_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 130 ), tfa_results.delay_bound );
		assertEquals( "TFA ARB backlog", new Num( 550 ), tfa_results.backlog_bound );
	}
	...
	public void f1_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 355, 6 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 625, 2 ), sfa_results.backlog_bound );
	}
	...
	public void f1_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 235, 3 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 1225, 3 ), sfa_results.backlog_bound );
	}
	...
	public void f1_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 190, 3  ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 1000, 3 ), pmoo_results.backlog_bound );
	}
}