 ...
 *
 */
public class Tandem_1SC_4Flows_1AC_1Path
{
	Configuration config;
	
	static final ServiceCurve service_curve = ServiceCurve.createRateLatency( 10, 10 );
	static final ArrivalCurve arrival_curve = ArrivalCurve.createTokenBucket( 2, 10 );
	...
	public Tandem_1SC_4Flows_1AC_1Path( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
...
//--------------------Flow 0--------------------	
	...
	public void f0_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 36 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 200 ), tfa_results.backlog_bound );
	}
	...
	public void f0_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 180 ), tfa_results.delay_bound );
		assertEquals( "TFA ARB backlog", new Num( 200 ), tfa_results.backlog_bound );
	}
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 34.5 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 74 ), sfa_results.backlog_bound );
	}
	...
	public void f0_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 82.5 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 170 ), sfa_results.backlog_bound );
	}
	...
	public void f0_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 60 ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 125 ), pmoo_results.backlog_bound );
	}
