 ...
 *
 */
public class Tandem_1SC_2Flows_1AC_2Paths
{
	...
	public Tandem_1SC_2Flows_1AC_2Paths( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
...
//--------------------Flow 0--------------------	
	...
	public void f0_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 48.75 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 350 ), tfa_results.backlog_bound );
	}
	...
	public void f0_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 305, 4 ), tfa_results.delay_bound );
		assertEquals( "TFA ARB backlog", new Num( 350 ), tfa_results.backlog_bound );
	}
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 515, 12 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 925, 4 ), sfa_results.backlog_bound );
	}
	...
	public void f0_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 50 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 800, 3 ), sfa_results.backlog_bound );
	}
	...
	public void f0_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB backlog", new Num( 800, 3 ), pmoo_results.backlog_bound );
	}
...
//--------------------Flow 1--------------------	
	...
	public void f1_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 55, 2 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 350 ), tfa_results.backlog_bound );
	}
	...
	public void f1_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 55 ), tfa_results.delay_bound );
		assertEquals( "TFA ARB backlog", new Num( 350 ), tfa_results.backlog_bound );
	}
	...
	public void f1_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 335, 12 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 625, 4 ), sfa_results.backlog_bound );
	}
	...
	public void f1_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 110, 3 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 200 ), sfa_results.backlog_bound );
	}
	...
	public void f1_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 110, 3 ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 200 ), pmoo_results.backlog_bound );
	}
}