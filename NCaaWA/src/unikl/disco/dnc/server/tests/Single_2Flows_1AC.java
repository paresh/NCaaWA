 ...
 *
 */
public class Single_2Flows_1AC
{
	...
	public Single_2Flows_1AC( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
...
//--------------------Flow 0--------------------
	...
	public void f0_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 15 ), tfa_results.delay_bound );
		assertEquals( "TFA FIFO backlog", new Num( 150 ), tfa_results.backlog_bound );
	}
	...
	public void f0_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB backlog", new Num( 150 ), tfa_results.backlog_bound );
	}
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 35, 2 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 175, 2 ), sfa_results.backlog_bound );
	}
	...
	public void f0_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 30 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 150 ), sfa_results.backlog_bound );
	}
	...
	public void f0_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 30 ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 150 ), pmoo_results.backlog_bound );
	}
