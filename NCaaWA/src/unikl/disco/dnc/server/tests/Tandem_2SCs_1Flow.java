 ...
 *
 */
public class Tandem_2SCs_1Flow
{
	...
	public Tandem_2SCs_1Flow( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
	...
	public void f0_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 31 ), tfa_results.delay_bound );
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 121, 6 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 105 ), sfa_results.backlog_bound );
	}
	...
	public void f0_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 121, 6 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 105 ), sfa_results.backlog_bound );
	}
	...
	public void f0_pmoo_arbMux()
	{
		...
		assertEquals( "PMOO ARB delay", new Num( 121, 6 ), pmoo_results.delay_bound );
		assertEquals( "PMOO ARB backlog", new Num( 105 ), pmoo_results.backlog_bound );
	}
}