 ...
 *
 */
public class Tree_1SC_2Flows_1AC_2Paths
{
	...
	public Tree_1SC_2Flows_1AC_2Paths( HashSet<ArrivalBoundMethods> arrival_boundings, boolean iterative_ab, boolean remove_duplicates ) {
...
//--------------------Flow 0--------------------	
	...
	public void f0_tfa_fifoMux()
	{
		...
		assertEquals( "TFA FIFO delay", new Num( 53.75 ), tfa_results.delay_bound );
	...
	public void f0_tfa_arbMux()
	{
		...
		assertEquals( "TFA ARB delay", new Num( 345, 4 ), tfa_results.delay_bound );
	...
	public void f0_sfa_fifoMux()
	{
		...
		assertEquals( "SFA FIFO delay", new Num( 575, 12 ), sfa_results.delay_bound );
		assertEquals( "SFA FIFO backlog", new Num( 1025, 4 ), sfa_results.backlog_bound );
	}
	...
	public void f0_sfa_arbMux()
	{
		...
		assertEquals( "SFA ARB delay", new Num( 170, 3 ), sfa_results.delay_bound );
		assertEquals( "SFA ARB backlog", new Num( 300 ), sfa_results.backlog_bound );
	}
